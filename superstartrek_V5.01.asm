...
; ===============================================
init_game:
    ; Seed aléatoire basé sur contenu mémoire
    lda $00
    eor #$5A
    sta rnd_seed
    lda $01
...
clear_galaxy:
    ...
    ; Générer galaxie V5.01 : 20 Klingons, 1 base, max 3/quadrant
    ; Phase 1 : étoiles seulement dans tous les quadrants
    ldx #0
gen_galaxy_loop:
    ; Étoiles (1-8) dans chaque quadrant
    jsr random
    and #$07
    clc
    adc #1
...
gen_k_loop:
    ...
    ; Extraire Klingons actuels (centaines)
    lda galaxy,x
    sta temp4           ; sauvegarder valeur

    ; Compter centaines
    lda #0
    sta temp5           ; compteur K dans ce quadrant
    lda temp4
gen_k_count:
    cmp #100
    bcc gen_k_check_max
...
enter_quadrant:
    ...
    ; Extraire K3 (Klingons = centaines)
    lda #0
    sta K3
    lda temp1
eq_count_k:
